...
IF NOT EXISTS (
    ...
    WHERE [MigrationId] = N'20251217164957_Initial'
)
BEGIN
    CREATE TABLE [Departments] (
        ...
        [CreateEmployeeId] nvarchar(max) NULL,
        [CreateDate] datetime2 NOT NULL,
        [UpdateEmployeeId] nvarchar(max) NULL,
...
BEGIN
    CREATE TABLE [Surveys] (
        ...
        CONSTRAINT [FK_Surveys_Parameters_ParameterTypeId] FOREIGN KEY ([ParameterTypeId]) REFERENCES [Parameters] ([Id]) ON DELETE NO ACTION
    );
END;
...
BEGIN
    CREATE TABLE [Questions] (
        ...
        CONSTRAINT [FK_Questions_Parameters_ParameterTypeId] FOREIGN KEY ([ParameterTypeId]) REFERENCES [Parameters] ([Id]) ON DELETE NO ACTION,
...
BEGIN
    IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'Code', N'CreateDate', N'CreateEmployeeId', N'Description', N'DisplayName', N'GroupName', N'IsActive', N'IsDeleted', N'LevelNo', N'Name', N'OrderNo', N'ParentId', N'Symbol', N'UpdateDate', N'UpdateEmployeeId') AND [object_id] = OBJECT_ID(N'[Parameters]'))
        SET IDENTITY_INSERT [Parameters] ON;
    EXEC(N'INSERT INTO [Parameters] ([Id], [Code], [CreateDate], [CreateEmployeeId], [Description], [DisplayName], [GroupName], [IsActive], [IsDeleted], [LevelNo], [Name], [OrderNo], [ParentId], [Symbol], [UpdateDate], [UpdateEmployeeId])
...
BEGIN
    CREATE INDEX [IX_Questions_ParameterTypeId] ON [Questions] ([ParameterTypeId]);
END;
...
BEGIN
    CREATE INDEX [IX_Surveys_ParameterTypeId] ON [Surveys] ([ParameterTypeId]);
END;
...
BEGIN
    ...
    VALUES (N'20251217164957_Initial', N'9.0.0');
END;
