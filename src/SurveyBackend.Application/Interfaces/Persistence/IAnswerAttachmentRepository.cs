...
{
    Task<AnswerAttachment?> GetByAnswerIdAsync(Guid answerId, CancellationToken cancellationToken);
    ...
    Task<AnswerAttachmentAccessInfo?> GetAccessInfoAsync(Guid attachmentId, CancellationToken cancellationToken);
}
